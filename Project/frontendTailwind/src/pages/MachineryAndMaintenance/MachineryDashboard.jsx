...
const MachineryDashboard = () => {
  ...
  const machAvailable = machinery.filter(
    (mach) => mach.others === 'Available'
  ).length;
                ...
                <div className="mt-5">
                  ...
                  <div className="flex flex-wrap lg:flex-nowrap justify-center mt-5">
                    <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
                      ...
                      <DashTopBox
                        icon={<GiMoneyStack />}
                        label="Total Machiery purchase Cost          "
                        data={'Rs.' + total + '.00'}
                      />
                      <DashTopBox
                        icon={<GiMoneyStack />}
                        label="Total Machinery Depreciation "
                        data={'Rs.' + prototal}
                      />
                      <DashTopBox
                        icon={<FaChartBar />}
