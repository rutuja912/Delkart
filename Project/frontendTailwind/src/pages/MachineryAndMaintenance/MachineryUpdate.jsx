                    ...
                    >
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          id="employeeFullName"
                          defaultValue={name}
                          placeholder="Enter the Machine name and model"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          defaultValue={dateOfPurchased}
                          placeholder="Enter the date of purchased"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="employeeNIC"
                          defaultValue={machineryCost}
                          placeholder="Enter the machinery cost"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          placeholder="Enter the estiamted salvage value"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="employeeDOB"
                          defaultValue={numberOfYrs}
                          placeholder="Enter the estimated life years"
                          required
                          onChange={(e) => {
