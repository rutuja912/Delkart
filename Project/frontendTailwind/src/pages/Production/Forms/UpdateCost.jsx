            ...
            <div>
              ...
              <div>
                ...
                <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl  dark:bg-secondary-dark-bg dark:text-white ">
                  <Header category="Form" title="Cost Sheet" />
                  <div className=" flex items-center justify-center">
                      ...
                      onSubmit={async (e) => {
                        ...
                        await axios
                          ...
                          .then(() => {
                            ...
                            Swal.fire({
                              icon: 'success',
                              title: 'Entry Costed Succesfully',
                              color: '#f8f9fa',
                              background: '#6c757d',
                    ...
                    >
                      ...
                      <div className="mb-3">
                        <label for="name" className="text-md">
                          Enter The Actual Days (8 hours a day)
                        </label>
                        <input
                          type="Number"
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          type="Number"
                          placeholder={budgetedoverHeadCost}
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="address"
                          onChange={(e) => {}}
                          readOnly
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          type="Number"
                          placeholder="Enter the actual overhead cost"
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="address"
                          onChange={(e) => {
