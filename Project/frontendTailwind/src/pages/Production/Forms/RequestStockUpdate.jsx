...
export default function UpdateStockRequest() {
  ...
  const budgetedtotalCost =
    budgetedLabCost + budgetedMatCost + parseFloat(budgetedoverHeadCost);
  //
  const totalCost = 0;
  ...
  const getOrder = () => {
    // ${process.env.REACT_APP_API_URL}/Production/order/pending/:invoiceNo
    // ${process.env.REACT_APP_API_URL}/sales/${id}
    axios
      .get(`${process.env.REACT_APP_API_URL}/Production/order/${id}`)
      .then((res) => {
  ...
  useEffect(() => {
    //This will run the page when loaded
    getOrder();
    getEmployees();
  }, []);
                ...
                <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl  dark:bg-secondary-dark-bg dark:text-white ">
                  ...
                  <div className=" flex items-center justify-center">
                    ...
                    >
                      ...
                      <div className="mb-3">
                        ...
                        >
                          {employee
                            .filter((data) => {
                              return (
                                data.employeeType == 'Executive' &&
                                data.employeeDepartment == 'Production'
                              );
                            })
                            .map((data) => {
                              return (
                      ...
                      <div className="mb-3">
                        ...
                        >
                          {employee
                            .filter((data) => {
                              return (
                                data.employeeType == 'Non-Executive' &&
                                data.employeeDepartment == 'Production'
                              );
                            })
                            .map((data) => {
                      ...
                      <div className="mb-3">
                        <label for="name" className="text-md">
                          Enter the Estimated Labour Rate
                        </label>
                        <input
                          type="Number"
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                      ...
                      <div className="mb-3">
                        <label for="name" className="text-md">
                          Enter the Estimated Days (8 hours a day)
                        </label>
                        <input
                          type="Number"
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                      ...
                      <div className="mb-3">
                        <label for="address" className="text-md">
                          Estimated Labour Cost
                        </label>
                        <input
                          type="Number"
                          placeholder={budgetedLabCost}
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="address"
                          onChange={(e) => {
                            //setTotalLabCost();
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          type="Number"
                          placeholder="Enter the expected overhead cost"
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="address"
                          onChange={(e) => {
