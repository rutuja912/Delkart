...
export default function CostedDateRange() {
  ...
  const toGenerateReport = () => {
    navigate('/CostedFilteredPreview', {
  ...
  async function getOrders() {
    await axios
      .get(
        `${process.env.REACT_APP_API_URL}/production/order/date/${location.state.DS}/${location.state.DE}`
      )
      .then((res) => {
        setOrder(res.data);
      })
                          ...
                          if (data.status == 'Costed') {
                            ...
                            return (
                              ...
                              >
                                ...
                                />
                                <TableData
                                  value={formatter.format(data.totalCost)}
                                />
                                <td
                                ...
                                >
                                  <TableData
                                    value={formatter.format(
                                      data.budgetedtotalCost - data.totalCost
                                    )}
                                  />
                                </td>
