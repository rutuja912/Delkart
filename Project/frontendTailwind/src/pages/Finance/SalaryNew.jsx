                  ...
                  <div className=" flex items-center justify-center ">
                    <form
                      onSubmit={async (e) => {
                        ...
                        await axios
                          .post(
                            'http://localhost:8070/salary/SalaryNew',
                            newSalary
                          )
                          .then((res) => {
                    ...
                    >
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          title="Employee ID must be a 4 Digit Numeric value"
                          pattern="[0-9]{4}"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        <label for="employeeBasicSalary" className="form-label">
                          Basic Salary :{' '}
                        </label>
                        <input
                          type="number"
                          ...
                          placeholder="Enter a Basic Salary"
                          min="1"
                      ...
                      <div className="mb-3">
                        <label for="employeeAllowance" className="form-label">
                          Allowance :{' '}
                        </label>
                        <input
                          type="number"
                      ...
                      <div className="mb-3">
                        <label for="employeeIncentive" className="form-label">
                          Incentive :{' '}
                        </label>
                        <input
                          type="number"
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="employeeIncentive"
