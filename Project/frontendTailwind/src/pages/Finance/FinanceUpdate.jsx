            ...
            <div>
              ...
              <div>
                ...
                <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl  dark:bg-secondary-dark-bg dark:text-white ">
                  <Header
                    category="Form"
                    title="Update Cash Transaction Entry"
                  />
                  <div className=" flex items-center justify-center">
                    ...
                    >
                      <div className="mb-3">
                        <label htmlFor="trnNumber" className="text-md">
                          Transaction Number :{' '}
                        </label>
                        <input
                          type="text"
                          ...
                          pattern="[A-Z]{1}[0-9]{3}"
                          title="The Transaction ID must start with one uppercase character, followed by 3 Numeric digits"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        <label htmlFor="trnDescription" className="form-label">
                          Description :{' '}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label htmlFor="trnAmount" className="form-label">
                          Amount :{' '}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label htmlFor="trnType" className="form-label">
                          Type of Transaction:{' '}
                        </label>
                        <select
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="trnType"
                          defaultValue={trnType}
                      ...
                      <div className="mb-3">
                        <label htmlFor="trnDate" className="form-label">
                          Transaction Date :{' '}
                        </label>
                        <input
                          type="date"
