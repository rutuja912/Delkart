                        ...
                        <tbody>
                          {Salary.filter((data) => {
                            if (searchTerm == '') {
                              ...
                              data.employeeInfo.employeeNameWithInitials
                                .toString()
                                .toLowerCase()
                                .includes(searchTerm.toLowerCase()) ||
                              data.employeeInfo.employeeDesignation
                                .toString()
                                .toLowerCase()
                                .includes(searchTerm.toLowerCase())
                            ) {
                            ...
                            <tr className="text-sm h-10 border dark:border-slate-600">
                              ...
                              />
                              <TableData
                                value={data.employeeInfo.employeeDesignation}
                              />
                              <TableData
                              ...
                              />
                              <TableData
                                value={formatter.format(data.employeeAllowance)}
                              />
                              <TableData
                                value={formatter.format(data.employeeIncentive)}
                              />
                              <TableData
                                value={formatter.format(
                                  data.employeeIncentive +
