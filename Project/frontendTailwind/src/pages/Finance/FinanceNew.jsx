                      ...
                      onSubmit={async (e) => {
                        ...
                        await axios
                          ...
                          .catch((err) => {
                            console.log(err);
                            alert(
                              'Conflicting Transaction ID! Please enter a unique Transaction ID'
                            );
                          });
                      }}
                    >
                      ...
                      <div className="mb-3">
                        <label for="trnAmount" className="form-label">
                          Amount :{' '}
                        </label>
                        <input
                          type="number"
                      ...
                      <div className="mb-3">
                        <label for="trnType" className="form-label">
                          Type :{' '}
                        </label>
                        <select
                      ...
                      <div className="mb-3">
                        <label for="trnDate" className="form-label">
                          Date of Transaction :{' '}
                        </label>
                        <input
                          type="date"
