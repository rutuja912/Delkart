                    ...
                    return (
                      <div>
                        ...
                        <div className="bg-contain w-full">
                          <div
                            id="invoiceView"
                            className="border border-black w-3/4 mx-40 mt-8 px-12 bg-white  dark:bg-secondary-dark-bg dark:text-white"
                          >
                            ...
                            <div className="mt-5">
                              ...
                              <div className="mx-12 px-16">
                                ...
                                {data.customerDetailss.map((data2) => {
                                  ...
                                  let customerContactNo =
                                    data2.customerContactNo;
