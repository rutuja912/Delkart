...
const VehiMaintenanceViewAll = () => {
  ...
  const toDateRange = () => {
    navigate('/VehiMaintenanceDateRange', {
  ...
  const filterDate = () => {
    if (dateRangeRef.value && dateRangeRef.value.length > 0) {
      ...
      setDateStart(start);
      setDateEnd(end);
      navigate('/VehiMaintenanceDateRange', { state: { DS: start, DE: end } });
    } else {
                              ...
                              return (
                                ...
                                (
                                  ...
                                  >
                                    ...
                                    <TableData
                                      value={data.vehicleDetails.map(
                                        (data2) => {
                                          return (
                                            <div>
                                              <Link to={'/DriverViewAll/'}>
                                                <TableData
                                                  value={data2.vehicleModel}
                                                />
                                              </Link>
                                            </div>
                                          );
                                    ...
                                    <TableData
                                      value={formatter.format(data.others)}
                                    />
                                    <td
                                    ...
                                    <td className="text-center px-3 align-middle border-l-0 border-r-0 text-m whitespace-nowrap p-3">
                                      <Link
                                        to={`/VehiMaintenanceUpdate/${data._id}`}
                                      >
                                        <button
                                          type="button"
