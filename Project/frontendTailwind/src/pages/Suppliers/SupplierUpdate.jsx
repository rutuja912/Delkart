                ...
                <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl  dark:bg-secondary-dark-bg dark:text-white ">
                  ...
                  <div className=" flex items-center justify-center">
                    ...
                    >
                      ...
                      <div className="mb-3">
                        <label htmlFor="contactPerson" className="text-md">
                          Contact Person :{' '}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label htmlFor="productDetails" className="text-md">
                          Product Details :{' '}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label htmlFor="leadTime" className="text-md">
                          Lead Time :{' '}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label htmlFor="orderCapacity" className="text-md">
                          Order Capacity :{' '}
                        </label>
                        <input
                          type="text"
