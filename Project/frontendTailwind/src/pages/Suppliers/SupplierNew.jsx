                  ...
                  <div className=" flex items-center justify-center ">
                    <form
                      onSubmit={async (e) => {
                        ...
                        await axios
                          .post(
                            'http://localhost:8070/supplier/create',
                            newSupplier
                          )
                          .then((res) => {
                    ...
                    >
                      <div className="mb-3">
                        <label for="supplierId" className="form-label">
                          Supplier ID :{' '}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label for="productDetails" className="form-label">
                          Product Details :{' '}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label for="leadTime" className="form-label">
                          Lead Time :{' '}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        <label for="orderCapacity" className="form-label">
                          Order Capacity :{' '}
                        </label>
                        <input
                          type="text"
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="orderCapacity"
                          placeholder="Enter the order capacity"
                          required
                          onChange={(e) => {
