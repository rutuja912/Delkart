                ...
                <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl  dark:bg-secondary-dark-bg dark:text-white ">
                  ...
                  <div className=" flex items-center justify-center ">
                    ...
                    >
                      ...
                      <div className="mb-3">
                        <label htmlFor="employeeInTime" className="form-label">
                          Employee In Time :{' '}
                        </label>
                        <input
                          type="datetime-local"
                      ...
                      <div className="mb-3">
                        <label htmlFor="employeeOutTime" className="form-label">
                          Employee Out Time :{' '}
                        </label>
                        <input
                          type="datetime-local"
                      ...
                      <div className="mb-3">
                        <label htmlFor="employeeOTHours" className="form-label">
                          Employee OT Hours :{' '}
                        </label>
                        <input
                          type="number"
                      ...
                      <div className="mb-3">
                        ...
                        <select
                          ...
                          title="Select the attendance status"
                          required="required"
