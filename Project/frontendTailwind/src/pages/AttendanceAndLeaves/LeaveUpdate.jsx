                    ...
                    >
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          required
                          pattern="[0-9]{4}"
                          title="Employee number should be a 4 digit number"
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        <label htmlFor="leaveStartDate" className="text-md">
                          Leave Start Date :{' '}
                        </label>
                        <input
                          type="date"
                          ...
                          placeholder="Enter the leave start date"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        <label htmlFor="leaveEndDate" className="text-md">
                          Leave End Date :{' '}
                        </label>
                        <input
                          type="date"
                          ...
                          placeholder="Enter the leave end date"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        <label htmlFor="leaveReason" className="text-md">
                          Leave Reason :{' '}
                        </label>
                        <input
                          type="text"
                          ...
                          required
                          pattern="[A-Za-z]{3,}"
                          title="Leave reason should be a minimum of 3 characters"
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        <label htmlFor="leaveStatus" className="text-md">
                          Leave Status :{' '}
                        </label>
                        <select
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
