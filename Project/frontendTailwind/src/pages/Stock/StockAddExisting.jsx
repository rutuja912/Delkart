                  ...
                  <div className=" flex items-center justify-center ">
                    <form
                      onSubmit={async (e) => {
                        ...
                        {
                          stock
                            .filter((stock) => stock.stockCode === stockCode)
                            .map((stock) => {
...

                        {
                          if (checkExists === '') {
                            alert(
                              'Entry does not exist in stock information.For non existing stocks addition, please add from stock information page'
                            );
                            navigate('/StockDashboard');
                          } else {
