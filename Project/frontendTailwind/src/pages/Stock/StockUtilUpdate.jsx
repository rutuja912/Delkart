...
function StockUtilUpdate() {
  ...
  const getStockUtil = () => {
    axios
      .get('http://localhost:8070/stockUtilisation/' + id)
      .then((res) => {
                  ...
                  <div className=" flex items-center justify-center">
                    <form
                      onSubmit={async (e) => {
                        ...
                        await axios
                          .put(
                            'http://localhost:8070/stockUtilisation/update/' +
                              id,
                            newStockUtil
                          )
                          .then((res) => {
                    ...
                    >
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          min="0"
                          required
                          title="If there is no stock please enter 0"
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          type="text"
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white
                         dark:text-black"
                          id="supplier"
                          value={supplier}
                          readOnly
