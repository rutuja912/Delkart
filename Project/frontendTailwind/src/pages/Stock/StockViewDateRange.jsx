...
function StockViewDateRange() {
  ...
  const toGenerateReport = () => {
    navigate('/StockViewDateRangePDF', {
...

                            {
                              stockUtil
                                ...
                                .map((stockUtil) => {
                                  ...
                                  if (
                                    stockUtil.stockCategory === 'Raw materials'
                                  )
                                    totRM +=
                                      stockUtil.quantity * stockUtil.unitPrice;
                                  if (
                                    stockUtil.stockCategory ===
                                    'Work in progress'
                                  )
                                    totWIP +=
                                      stockUtil.quantity * stockUtil.unitPrice;
...
export default StockViewDateRange;
