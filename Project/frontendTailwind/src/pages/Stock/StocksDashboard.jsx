...
const StocksDashboard = () => {
  ...
  const countRawMaterials = stock.filter(
    (stk) => stk.stockCategory === 'Raw materials'
  ).length;
  const countWorkInProgress = stock.filter(
    (stk) => stk.stockCategory === 'Work in progress'
  ).length;
  var totalDamaged = 0;
                  ...
                  <div className="flex flex-wrap lg:flex-nowrap justify-left ml-5 mt-5">
                    <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
                      ...
                      <Link to="/StockView">
                        <DashTopButton
                          icon={<FaWarehouse />}
                          value="View All Stocks"
                        />
                      </Link>
                      <Link to="/StockBreakdown">
                        <DashTopButton
                          icon={<FaFileSignature />}
                          value="View Stocks Breakdown"
                        />
                      </Link>
                      <Link to="/StockAdd">
                        <DashTopButton
                      ...
                      <Link to="/StockUtilAddOption">
                        <DashTopButton
                          icon={<FaLayerGroup />}
                          value="Add New Entry for exisitng stock"
                        />
                      </Link>
                    </div>
                  </div>
