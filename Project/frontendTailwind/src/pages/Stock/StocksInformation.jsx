                    ...
                    <div id="report">
                      ...
                      <div className="bg-main-bg dark:bg-main-dark-bg rounded-3xl p-5 m-5">
                        ...
                        <div className="text-md ml-12 pt-5">
                          ...
                          <div className="p-1">
                            <span className="font-bold">Damaged Units</span> :{' '}
                            {data.damagedQty}
                          </div>
                          <div className="p-1">
                          ...
                          <div className="p-1">
                            <span className="font-bold">Buffer Stock</span> :{' '}
                      ...
                      <div className="bg-main-bg dark:bg-main-dark-bg rounded-3xl p-5 m-5">
                        ...
                        <div className="text-md ml-12 pt-5">
                          <div className="p-1">
                            ...
                            : {data.firstPurchaseDate.split('T')[0]}
                          </div>
                          <div className="p-1">
                          ...
                          <div className="p-1">
                            <span className="font-bold">Last Issue</span> :{' '}
                            {lastIssue}
                          </div>
                        </div>
                      </div>
