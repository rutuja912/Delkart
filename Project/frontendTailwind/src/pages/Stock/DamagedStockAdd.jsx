    ...
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl  dark:bg-secondary-dark-bg dark:text-white ">
      ...
      <div className=" flex items-center justify-center ">
        ...
        >
          ...
          <div className="mb-3">
            <label for="damagedStockName" className="form-label">
              Stock Name:{' '}
            </label>
            <input
              type="text"
          ...
          <div className="mb-3">
            <label for="damagedStockCategory" className="form-label">
              Category:{' '}
            </label>
            <select
          ...
          <div className="mb-3">
            ...
            <input
              ...
              min="0"
              step="0.01"
              title="If the value of the damaged stock is not avilable or no value please enter 0"
              required
              onChange={(e) => {
          ...
          <div className="mb-3">
            <label for="usability" className="form-label">
              Usability:{' '}
            </label>
            <select
              class="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
