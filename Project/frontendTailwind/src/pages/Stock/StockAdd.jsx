                  ...
                  <div className=" flex items-center justify-center ">
                    <form
                      onSubmit={async (e) => {
                        ...
                        await axios
                          .post('http://localhost:8070/stock/create', newStock)
                          .then(() => {
                            Swal.fire({
                              icon: 'success',
                    ...
                    >
                      <div className="mb-3">
                        <label for="stockCode" className="form-label">
                          Stock Code:{' '}
                        </label>
                        <input
                          type="text"
                          ...
                          title="The code needs to start with one uppercase letter, atleast 3 digits and should not exceed 8 characters"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        <label for="bundlename" className="form-label">
                          Stock Name
                        </label>
                        <select
                          className="mt-1 block w-800 rounded-md bg-gray-100 focus:bg-white dark:text-black"
                          id="bundlename"
                          placeholder="Enter Stock Bundle Name..."
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        ...
                        <select
                          ...
                          id="stockCategory"
                          title="Please choose one of the options"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        ...
                        <textarea
                          ...
                          title="The name can contain only alphabets"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          min="0"
                          title="If there is no stock please input 0"
                          required
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          min="0"
                          title="If the unit price is not avilable please enter 0"
                          step="0.01"
                          onChange={(e) => {
                      ...
                      <div className="mb-3">
                        <label for="totalValue" className="form-label">
                          Total Value:{' '}
                        </label>
                        <input
                          type="number"
