                        ...
                        <div className="bg-main-bg dark:bg-main-dark-bg rounded-3xl p-5 m-5">
                          ...
                          <div className="text-md ml-12 pt-5">
                            <div className="p-1">
                              ...
                              {new Date(data.employeeDateOfJoin)
                                .toISOString()
                                .substring(0, 10)}
                            </div>
                            <div className="p-1">
                        ...
                        <div className="bg-main-bg dark:bg-main-dark-bg rounded-3xl p-5 m-5">
                          ...
                          <div className="text-md ml-12 pt-5">
                            <div className="p-1">
                              ...
                              :{' '}
                              {formatter.format(
                                data.salaryDetails.employeeBasicSalary
                              )}
                            </div>
                            <div className="p-1">
                              {' '}
                              ...
                              {formatter.format(
                                data.salaryDetails.employeeAllowance
                              )}
                            </div>
                            <div className="p-1">
                              {' '}
                              ...
                              {formatter.format(
                                data.salaryDetails.employeeIncentive
                              )}
                            </div>
                            <div className="p-1">
                              {' '}
                    ...
                    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-3xl  dark:bg-secondary-dark-bg dark:text-white ">
                      ...
                      <div className=" flex items-center mb-5 ">
                        <div className="font-bold text-lg">
                          {' '}
                          <span> Leaves left for {thisYear} </span> :{' '}
                          {leaveCount}
                        </div>
                      </div>
                      <div className=" flex items-center mb-5 ">
                            ...
                            {data.leavesDetails
                              .filter((leave) => {
                                if (month == '' && year == '') {
                                  ...
                                  month ==
                                    new Date(leave.leaveStartDate).getMonth() &&
                                  year ==
                                    new Date(leave.leaveStartDate).getFullYear()
                                ) {
                                  return leave;
                                }
                              })
