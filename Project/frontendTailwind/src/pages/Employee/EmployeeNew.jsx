                  ...
                  <div className=" flex items-center justify-center">
                    <form
                      onSubmit={async (e) => {
                        ...
                        await axios
                          .post(
                            'http://localhost:8070/employee/createEmployee',
                            newEmployee
                          )
                          .then((res) => {
                            Swal.fire({
                    ...
                    >
                      ...
                      <div className="mb-3">
                        <label for="employeeNumber" className="form-label">
                          Employee Number :{' '}
                        </label>
                        <input
                          type="number"
                          ...
                          maxLength={4}
                          title={
                            'The Employee Number requires a 4 digit number'
                          }
                      ...
                      <div className="mb-3">
                        <label for="employeeFullName" className="form-label">
                          Full name :{' '}
                        </label>
                        <input
                          type="text"
                          ...
                          pattern="[A-Za-z ]{3,}"
                          title={
                            'The Full Name requires a minimum of 3 characters'
                          }
                        />
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          pattern="[A-Za-z ]{3,}"
                          title={
                            'The Name with Initials requires a minimum of 3 characters'
                          }
                        />
                      </div>
                      ...
                      <div className="mb-3">
                        <label for="employeeGender" className="form-label">
                          Gender :{' '}
                        </label>
                        <select
                      ...
                      <div className="mb-3">
                        <label for="employeeDOB" className="form-label">
                          Date of Birth :{' '}
                        </label>
                        <input
                          type="date"
                      ...
                      <div className="mb-3">
                        <label for="employeeDateOfJoin" className="form-label">
                          Date joined :{' '}
                        </label>
                        <input
                          type="date"
                      ...
                      <div className="mb-3">
                        <label for="employeeDesignation" className="form-label">
                          Designation :{' '}
                        </label>
                        <input
                          type="text"
                          ...
                          pattern="[A-Za-z ]{3,}"
                          title={
                            'The Designation requires a minimum of 3 characters'
                          }
                        />
                      </div>

                      <div className="mb-3">
                        <label for="employeeDepartment" className="form-label">
                          Department :{' '}
                        </label>
                        <select
                          type="text"
                      ...
                      <div className="mb-3">
                        <label for="employeeAddress" className="form-label">
                          Address :{' '}
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          maxLength={10}
                          title={
                            'The Contact Number requires a 10 digit number'
                          }
                        />
                      </div>

                      <div className="mb-3">
                        <label for="employeeEmail" className="form-label">
                          Email :{' '}
                        </label>
                        <input
                          type="text"
