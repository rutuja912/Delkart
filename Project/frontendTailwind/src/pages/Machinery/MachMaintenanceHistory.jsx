                  ...
                  <div className="bg-main-bg dark:bg-main-dark-bg rounded-3xl p-5 m-5">
                    ...
                    <div className="text-md ml-12 pt-5">
                      ...
                      <div className="p-1 ">
                        ...
                        {new Date(machinery.dateOfPurchased).toDateString()}
                      </div>
                      <div className="p-1 text-green-600 ">
                        ...
                        <span className="font-bold">
                          {' '}
                          + Purchased Cost{' '}
                        </span> : {formatter.format(machinery.machineryCost)}
                      </div>
                      <div className="p-1 text-green-600 ">
                        {' '}
                        <span className="font-bold">
                          {' '}
                          + Salvage Value{' '}
                        </span> : {formatter.format(machinery.salvage)}
                      </div>
                      <div className="p-1 text-green-600 ">
                        {' '}
                        <span className="font-bold">
                      ...
                      <div className="p-1 text-red-600 ">
                        ...
                        {formatter.format(
                          parseFloat(
                            (machinery.machineryCost - machinery.salvage) /
                              machinery.numberOfYrs
                          ).toFixed(2)
                        )}
                      </div>
