...
export default function SalesMonthlyChart() {
  ...
  let data = [
    { month: 'Jan', sales: janTotal },
    { month: 'Feb', sales: febTotal },
    { month: 'Mar', sales: marTotal },
    { month: 'Apr', sales: aprTotal },
    { month: 'May', sales: mayTotal },
    { month: 'Jun', sales: junTotal },
    { month: 'Jul', sales: julTotal },
    { month: 'Aug', sales: augTotal },
    { month: 'Sep', sales: sepTotal },
    { month: 'Oct', sales: octTotal },
    { month: 'Nov', sales: novTotal },
    { month: 'Dec' },
  ];
