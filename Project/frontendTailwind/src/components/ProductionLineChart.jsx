...
export default function ProductionLineChart() {
  ...
  for (let index = 0; index < salesLen; index++) {
    ...
    switch (new Date(Orders[index].requestDate).getMonth()) {
      ...
      case 7:
        augTotal =
          parseFloat(augTotal) + Orders[index].budgetedtotalCosttotalCost;
  ...
  let material = [
    { month: 'Jan', Material: janMat },
    { month: 'Feb', Material: febMat },
    { month: 'Mar', Material: marMat },
    { month: 'Apr', Material: aprMat },
    { month: 'May', Material: mayMat },
    { month: 'Jun', Material: junMat },
    { month: 'Jul', Material: julMat },
    { month: 'Aug', Material: augMat },
    { month: 'Sep', Material: sepMat },
    { month: 'Oct', Material: octMat },
    { month: 'Nov', Material: novMat },
    { month: 'Dec', Material: decMat },
  ];

  let data = [
    { month: 'Jan', Total: janTotal },
    { month: 'Feb', Total: febTotal },
    { month: 'Mar', Total: marTotal },
    { month: 'Apr', Total: aprTotal },
    { month: 'May', Total: mayTotal },
    { month: 'Jun', Total: junTotal },
    { month: 'Jul', Total: julTotal },
    { month: 'Aug', Total: augTotal },
    { month: 'Sep', Total: sepTotal },
    { month: 'Oct', Total: octTotal },
    { month: 'Nov', Total: novTotal },
    { month: 'Dec' },
  ];
      ...
      >
        ...
        <SeriesCollectionDirective>
          ...
          <SeriesDirective
            ...
            xName="month"
            yName="Material"
            name="Monthly Budgeted Total Cost"
            marker={{ dataLable: { visible: true }, visible: true }}
          ></SeriesDirective>
        </SeriesCollectionDirective>
      </ChartComponent>
