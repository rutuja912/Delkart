...
export default function SalesMonthlyChart() {
  ...
  for (let index = 0; index < prodLen; index++) {
    if (prod[index].status === 'Costed') {
      switch (new Date(prod[index].requestDate).getMonth()) {
        ...
        case 10:
          novTotalProduction =
            parseInt(novTotalProduction) + prod[index].totalCost;
          break;
        case 11:
  ...
  let data = [
    { month: 'Jan', sales: janTotalSales },
    { month: 'Feb', sales: febTotalSales },
    { month: 'Mar', sales: marTotalSales },
    { month: 'Apr', sales: aprTotalSales },
    { month: 'May', sales: mayTotalSales },
    { month: 'Jun', sales: junTotalSales },
    { month: 'Jul', sales: julTotalSales },
    { month: 'Aug', sales: augTotalSales },
    { month: 'Sep', sales: sepTotalSales },
    { month: 'Oct', sales: octTotalSales },
    { month: 'Nov', sales: novTotalSales },
    { month: 'Dec' },
  ];

  let purchases = [
    { month: 'Jan', purchase: janTotalPurchase },
    { month: 'Feb', purchase: febTotalPurchase },
    { month: 'Mar', purchase: marTotalPurchase },
    { month: 'Apr', purchase: aprTotalPurchase },
    { month: 'May', purchase: mayTotalPurchase },
    { month: 'Jun', purchase: junTotalPurchase },
    { month: 'Jul', purchase: julTotalPurchase },
    { month: 'Aug', purchase: augTotalPurchase },
    { month: 'Sep', purchase: sepTotalPurchase },
    { month: 'Oct', purchase: octTotalPurchase },
    { month: 'Nov', purchase: novTotalPurchase },
    { month: 'Dec' },
  ];

  let production = [
    { month: 'Jan', prod: janTotalProduction },
    { month: 'Feb', prod: febTotalProduction },
    { month: 'Mar', prod: marTotalProduction },
    { month: 'Apr', prod: aprTotalProduction },
    { month: 'May', prod: mayTotalProduction },
    { month: 'Jun', prod: junTotalProduction },
    { month: 'Jul', prod: julTotalProduction },
    { month: 'Aug', prod: augTotalProduction },
    { month: 'Sep', prod: sepTotalProduction },
    { month: 'Oct', prod: octTotalProduction },
    { month: 'Nov', prod: novTotalProduction },
    { month: 'Dec' },
  ];

  let gross = [
    { month: 'Jan', gross: janTotalGross },
    { month: 'Feb', gross: febTotalGross },
    { month: 'Mar', gross: marTotalGross },
    { month: 'Apr', gross: aprTotalGross },
    { month: 'May', gross: mayTotalGross },
    { month: 'Jun', gross: junTotalGross },
    { month: 'Jul', gross: julTotalGross },
    { month: 'Aug', gross: augTotalGross },
    { month: 'Sep', gross: sepTotalGross },
    { month: 'Oct', gross: octTotalGross },
    { month: 'Nov', gross: novTotalGross },
    { month: 'Dec' },
  ];
