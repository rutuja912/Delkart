...
export default function StockUtilLineChart() {
  ...
  let addData = [
    { month: 'Jan', additions: janTotal1 },
    { month: 'Feb', additions: febTotal1 },
    { month: 'Mar', additions: marTotal1 },
    { month: 'Apr', additions: aprTotal1 },
    { month: 'May', additions: mayTotal1 },
    { month: 'Jun', additions: junTotal1 },
    { month: 'Jul', additions: julTotal1 },
    { month: 'Aug', additions: augTotal1 },
    { month: 'Sep', additions: sepTotal1 },
    { month: 'Oct', additions: octTotal1 },
    { month: 'Nov', additions: parseInt(novTotal1) },
    { month: 'Dec', additions: decTotal1 },
  ];
  ...
  let issueData = [
    { month: 'Jan', issues: janTotal2 },
    { month: 'Feb', issues: febTotal2 },
    { month: 'Mar', issues: marTotal2 },
    { month: 'Apr', issues: aprTotal2 },
    { month: 'May', issues: mayTotal2 },
    { month: 'Jun', issues: junTotal2 },
    { month: 'Jul', issues: julTotal2 },
    { month: 'Aug', issues: augTotal2 },
    { month: 'Sep', issues: sepTotal2 },
    { month: 'Oct', issues: octTotal2 },
    { month: 'Nov', issues: parseInt(novTotal2) },
    { month: 'Dec', issues: decTotal2 },
  ];
