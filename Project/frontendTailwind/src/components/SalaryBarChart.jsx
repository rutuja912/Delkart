...
const SalaryBarChart = () => {
  ...
  const under50 = sal.filter(
    (sal) =>
      sal.employeeIncentive + sal.employeeAllowance + sal.employeeBasicSalary <
      50000
  ).length;
  const between50and150 = sal.filter(
    (sal) =>
      sal.employeeIncentive + sal.employeeAllowance + sal.employeeBasicSalary >
        50000 &&
      sal.employeeIncentive + sal.employeeAllowance + sal.employeeBasicSalary <
  ...
  const barChartData = [
    ...
    {
      x: 'Between 50,001 LKR & 250,000 LKR',
      y: between50and150,
      color: '#A30000',
    },
