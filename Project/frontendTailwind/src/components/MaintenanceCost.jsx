...
export default function MaintenanceCost() {
  ...
  useEffect(() => {
    //useEffect is used to call the function getMaintainence
    getMaintainence();
  }, []);
  ...
  let data = [
    { month: 'Jan', maintainence: janTotal },
    { month: 'Feb', maintainence: febTotal },
    { month: 'Mar', maintainence: marTotal },
    { month: 'Apr', maintainence: aprTotal },
    { month: 'May', maintainence: mayTotal },
    { month: 'Jun', maintainence: junTotal },
    { month: 'Jul', maintainence: julTotal },
    { month: 'Aug', maintainence: augTotal },
    { month: 'Sep', maintainence: sepTotal },
    { month: 'Oct', maintainence: octTotal },
    { month: 'Nov', maintainence: parseInt(novTotal) },
    { month: 'Dec', maintainence: decTotal },
  ];
  ...
  for (let index = 0; index < maint2; index++) {
    console.log(
      new Date(maintainenceMachine[index].lastMaintainedDate).getMonth()
    );
    switch (
      new Date(maintainenceMachine[index].lastMaintainedDate).getMonth()
    ) {
  ...
  let maintainenceMachinedata = [
    { month: 'Jan', maintainenceMachine: janTotal1 },
    { month: 'Feb', maintainenceMachine: febTotal1 },
    { month: 'Mar', maintainenceMachine: marTotal1 },
    { month: 'Apr', maintainenceMachine: aprTotal1 },
    { month: 'May', maintainenceMachine: mayTotal1 },
    { month: 'Jun', maintainenceMachine: junTotal1 },
    { month: 'Jul', maintainenceMachine: julTotal1 },
    { month: 'Aug', maintainenceMachine: augTotal1 },
    { month: 'Sep', maintainenceMachine: sepTotal1 },
    { month: 'Oct', maintainenceMachine: octTotal1 },
    { month: 'Nov', maintainenceMachine: parseInt(novTotal1) },
    { month: 'Dec', maintainenceMachine: decTotal1 },
  ];
  ...
  for (let index = 0; index < maint3; index++) {
    console.log(
      new Date(maintainenceVehi[index].lastMaintainedDate).getMonth()
    );
  ...
  let maintainenceVehidata = [
    { month: 'Jan', maintainenceVehi: janTotal2 },
    { month: 'Feb', maintainenceVehi: febTotal2 },
    { month: 'Mar', maintainenceVehi: marTotal2 },
    { month: 'Apr', maintainenceVehi: aprTotal2 },
    { month: 'May', maintainenceVehi: mayTotal2 },
    { month: 'Jun', maintainenceVehi: junTotal2 },
    { month: 'Jul', maintainenceVehi: julTotal2 },
    { month: 'Aug', maintainenceVehi: augTotal2 },
    { month: 'Sep', maintainenceVehi: sepTotal2 },
    { month: 'Oct', maintainenceVehi: octTotal2 },
    { month: 'Nov', maintainenceVehi: parseInt(novTotal2) },
    { month: 'Dec', maintainenceVehi: decTotal2 },
  ];
      ...
      >
        ...
        <SeriesCollectionDirective>
          <SeriesDirective
            ...
            xName="month"
            yName="maintainence"
            name="Poperty Maintenance"
            marker={{ dataLable: { visible: true }, visible: true }}
          />
          <SeriesDirective
            type="Line"
            dataSource={maintainenceMachinedata}
            xName="month"
            yName="maintainenceMachine"
            name="Machine Maintainence"
            marker={{ dataLable: { visible: true }, visible: true }}
          />
          <SeriesDirective
            type="Line"
            dataSource={maintainenceVehidata}
            xName="month"
            yName="maintainenceVehi"
