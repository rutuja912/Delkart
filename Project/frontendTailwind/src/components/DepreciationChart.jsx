...
export default function DepreciationChart() {
  ...
  for (let index = 0; index < MachLen; index++) {
    ...
    switch (new Date(machinery[index].dateOfPurchased).getMonth()) {
      case 0:
        janTotal =
          janTotal +
          ((machinery[index].machineryCost - machinery[index].salvage) /
            machinery[index].numberOfYrs /
            machinery[index].machineryCost) *
            100;
        break;
      case 1:
        febTotal =
  ...
  let data = [
    { month: 'Jan', machinery: janTotal },
    { month: 'Feb', machinery: febTotal },
    { month: 'Mar', machinery: marTotal },
    { month: 'Apr', machinery: aprTotal },
    { month: 'May', machinery: mayTotal },
    { month: 'Jun', machinery: junTotal },
    { month: 'Jul', machinery: julTotal },
    { month: 'Aug', machinery: augTotal },
    { month: 'Sep', machinery: sepTotal },
    { month: 'Oct', machinery: octTotal },
    { month: 'Nov', machinery: parseInt(novTotal) },
    { month: 'Dec', machinery: decTotal },
  ];
