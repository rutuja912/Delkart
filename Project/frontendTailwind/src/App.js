...
import {
  ...
  LeaveUpdate,
  LeaveReport,
} from './pages/AttendanceAndLeaves';
import {
  WelfareDashboard,
  WelfareNew,
  WelfareReport,
...
import {
  ...
  IncomeStatementDateRangePreview,
  IncomeStatementPreview,
} from './pages/Finance';

import {
  MaintenanceDashboard,
  MachMaintenancePreDateRange,
  MaintenanceNew,
  MaintenanceUpdate,
  MaintenanceViewAll,
  MaintainenceTask,
  MaintainenceReport,
  MaintainenceDateRange,
  MachMaintenanceViewAll,
  MachMaintenanceNew,
  MachMaintenanceUpdate,
  MachManitenanceDateRange,
  MachMaintenanceReport,
  VehiMaintenanceViewAll,
  VehiMaintenanceNew,
  VehiMaintenanceUpdate,
  VehiMaintenanceReport,
  VehiMaintenanceDateRange,
} from './pages/Maintenance';
import {
  MachineryDashboard,
  MachineryPreviewDateRange,
  MachineryNew,
  MachineryUpdate,
  MachineryViewAll,
  MachineryReport,
  MachineryDateRange,
  MachMaintenanceHistory,
} from './pages/Machinery';
...
import {
  ...
  StockInformation,
  StockViewDateRange,
  StockViewDateRangePDF,
  StockBreakdownDateRange,
  StockBreakdownDateRangePDF,
  StockAdd,
  StockUpdate,
  StockPDF,
  StockBreakdown,
  StockBreakdownUpdate,
  StockBreakdownPDF,
  ViewAllRawMaterials,
  RawMaterialsReport,
  ViewAllWorkInProgress,
  WorkInProgressReport,
} from './pages/Stock';
import {
  AddStockForRequisition,
  IssuesForm,
  PendingStockAdd,
  PendingStockUpdate,
  StockRequisitionPDF,
  ProcessingRequest,
  ProcessingRequestPDF,
  ResolvedRequest,
  ResolvedRequestPDF,
  PendingStockRequisition,
} from './pages/PendingStock';
import {
  StockUtilisationDashboard,
  StockUtilPDF,
  StockUtilisationDateRange,
  StockUtilDateRangePDF,
  StockUtilisation,
  StockAddExisting,
  StockUtilAddOption,
  StockUtilUpdate,
...
import {
  ...
  SupplierUpdate,
  SupplierNew,
  PurchaseOrderDetailsDashboard,
  SupplierDetailsPreview,
  PurchaseOrderAdd,
  PurchaseOrderUpdate,
  PurchaseOrderPreview,
  PurchaseOrderView,
  RequestedOrdersUpdate,
  RequestedStock,
  PurchaseOrderDateRange,
  PurchaseOrderPreviewDateRange,
  ...
  <div>
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/FinancePreviewDateRange"
          element={<FinancePreviewDateRange />}
        />
        <Route path="/FinanceDateRange/" element={<FinanceDateRange />} />
        <Route path="/IncomeStatement" element={<IncomeStatement />} />
        <Route
          path="/IncomeStatementPreview"
          element={<IncomeStatementPreview />}
        />
        <Route
          path="/IncomeStatementDateRange"
          element={<IncomeStatementDateRange />}
        />
        <Route
          path="/IncomeStatementDateRangePreview"
          element={<IncomeStatementDateRangePreview />}
        />
        {/* salary management  */}
        ...
        <Route
          path="/MachMaintenanceHistory/:id"
          element={<MachMaintenanceHistory />}
        />
        <Route
          path="/MachineryPreviewDateRange"
          element={<MachineryPreviewDateRange />}
        />
        ...
        <Route
          path="/MaintainenceDateRange"
          element={<MaintainenceDateRange />}
        />
        <Route
          path="/MachMaintenanceViewAll"
          element={<MachMaintenanceViewAll />}
        />
        <Route path="/MachMaintenanceNew" element={<MachMaintenanceNew />} />
        <Route
          path="/MachMaintenanceUpdate/:id"
          element={<MachMaintenanceUpdate />}
        />
        <Route
          path="/MachMaintenanceReport"
          element={<MachMaintenanceReport />}
        />
        <Route
          path="/MachManitenanceDateRange/"
          element={<MachManitenanceDateRange />}
        />
        <Route
          path="/VehiMaintenanceViewAll"
          element={<VehiMaintenanceViewAll />}
        />
        <Route path="/VehiMaintenanceNew" element={<VehiMaintenanceNew />} />
        <Route
          path="/VehiMaintenanceUpdate/:id"
          element={<VehiMaintenanceUpdate />}
        />
        <Route
          path="/VehiMaintenanceReport"
          element={<VehiMaintenanceReport />}
        />
        <Route
          path="/VehiMaintenanceDateRange/"
          element={<VehiMaintenanceDateRange />}
        />
        <Route
          path="/MachMaintenancePreDateRange"
          element={<MachMaintenancePreDateRange />}
        />
        {/* sales management  */}
        ...
        <Route
          path="/CompletedOrdersDateRange"
          element={<CompletedOrdersDateRange />}
        />
        <Route path="/costedOrders" element={<CostedOrders />} />
        <Route
          path="/updateStockRequest/:id"
          element={<UpdateStockRequest />}
        />
        <Route path="/costedDateRange" element={<CostedDateRange />} />
        <Route
          path="/CostedFilteredPreview"
          element={<CostedFilteredPreview />}
        />
        ...
        <Route
          path="/ViewAllWorkInProgress"
          element={<ViewAllWorkInProgress />}
        />
        <Route path="/generateWIPPDF" element={<WorkInProgressReport />} />
        <Route path="/StockViewDateRange/" element={<StockViewDateRange />} />
        <Route
          path="/StockViewDateRangePDF/"
          element={<StockViewDateRangePDF />}
        />
        <Route path="/StockBreakdown" element={<StockBreakdown />} />
        <Route
          path="/StockBreakdownUpdate/:id"
          element={<StockBreakdownUpdate />}
        />
        <Route path="/generateSBPDF" element={<StockBreakdownPDF />} />
        <Route
          path="/StockBreakdownDateRange/"
          element={<StockBreakdownDateRange />}
        />
        <Route
          path="/StockBreakdownDateRangePDF/"
          element={<StockBreakdownDateRangePDF />}
        />
        <Route
          path="/PendingStockRequisitions"
          element={<PendingStockRequisition />}
        />
        <Route path="/PendingStockAdd" element={<PendingStockAdd />} />
        <Route
          path="PendingStockAddReq/:id"
          element={<AddStockForRequisition />}
        />
        ...
        <Route
          path="/generateProcessingRPDF"
          element={<ProcessingRequestPDF />}
        />
        ...
        <Route
          path="/StockUtilisationDashboard"
          element={<StockUtilisationDashboard />}
        />
        ...
        <Route
          path="/StockUtilisationDateRange/"
          element={<StockUtilisationDateRange />}
        />
        <Route
          path="/StockUtilDateRangePDF/"
          element={<StockUtilDateRangePDF />}
        />
        {/* Supplier management  */}
        ...
        <Route
          path="/PurchaseOrderDetailsDashboard"
          element={<PurchaseOrderDetailsDashboard />}
        />
        <Route
          path="/SupplierDetailsPreview"
          element={<SupplierDetailsPreview />}
        />
        ...
        <Route
          path="/PurchaseOrderPreview"
          element={<PurchaseOrderPreview />}
        />
        <Route path="/RequestedStock" element={<RequestedStock />} />
        <Route
          path="/RequestedOrdersUpdate/:id"
          element={<RequestedOrdersUpdate />}
        />
        <Route
          path="/PurchaseOrderDateRange/"
          element={<PurchaseOrderDateRange />}
        />
        <Route
          path="/PurchaseOrderPreviewDateRange"
          element={<PurchaseOrderPreviewDateRange />}
        />
        ...
        <Route
          path="/TransportReportDateRange"
          element={<TransportReportDateRange />}
        />
